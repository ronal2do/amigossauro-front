...
export default class Contact extends React.Component {
  ...
  componentDidMount() {
      window.requestAnimFrame = (function(){ // eslint-disable-line
      ...
      function scrollToY(scrollTargetY, speed, easing) { // eslint-disable-line
          // scrollTargetY: the target scrollY property of the window
          // speed: time in pixels per second
          // easing: easing equation to use

          var scrollY = window.scrollY,
              scrollTargetY = scrollTargetY || 0,  // eslint-disable-line
              speed = speed || 2000, // eslint-disable-line
              easing = easing || 'easeOutSine', // eslint-disable-line
              currentTime = 0;
          ...
          var PI_D2 = Math.PI / 2, // eslint-disable-line
              easingEquations = {
                  ...
                  easeInOutQuint: function (pos) {
                      if ((pos /= 0.5) < 1) { // eslint-disable-line
          ...
          function tick() {
              ...
              if (p < 1) { // eslint-disable-line
                  requestAnimFrame(tick); // eslint-disable-line
